...
import 'package:flutter_camera_example/screens/gallery_screen.dart';
...
class PreviewSettingsScreen extends StatefulWidget {
  ...
  @override
  _PreviewSettingsScreenState createState() => _PreviewSettingsScreenState();
}
        ...
        children: [
          ...
          TextField(
            ...
            decoration: InputDecoration(
              ...
              suffixIcon: const Icon(Icons.help_outline, color: Colors.blue),
                      ...
                      children: [
                        Expanded(
                          ...
                          child: ColorPickerWidget(
                            initialColor: Colors
                                .blue, // Optional: provide an initial color
                            onColorChanged: (Color? color) {
                              if (color != null) {
                                print(
                                    'Selected primary color: ${color.value.toRadixString(16)}');
                              } else {
                                print('Primary color selection reset');
                              }
                              // Handle the color change in your app's state
                            },
                          ),
                        ),
                        const SizedBox(width: 15),
                        ...
                        Expanded(
                          ...
                          child: ColorPickerWidget(
                            ...
                            onColorChanged: (Color? color) {
                              if (color != null) {
                                print(
                                    'Selected color: ${color.value.toRadixString(16)}');
                              } else {
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          _buildProgressStep(3, 'כרטיס ביקור', true),
        ],
      ),
    );
  }
          ...
          Container(
            decoration: BoxDecoration(
              ...
              image: const DecorationImage(
                image: AssetImage(
                    'assets/home_interior.avif'), // Replace with your image path
                fit: BoxFit.cover,
              ),
            ),
            child: AspectRatio(
